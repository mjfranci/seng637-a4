...
public class RangeTestSuiteImproved {
...
//	Added the following tests to improve mutation coverage
	
	@Test
	public void testGetLength() {
		assertEquals("Should return 200", 200.0, exampleRange.getLength(), 0.01d);
	}
	
	@Test
	public void testGetCentralValue() {
		assertEquals("Should return 0", 0.0, exampleRange.getCentralValue(), 0.01d);
	}
	
	@Test
	public void testContains() {
		assertTrue("Range should contain 0.0", exampleRange.contains(0));
	}
	
	@Test
	public void testCombineNullRange1() {
		assertEquals("Combining a null range with example range should return example range", exampleRange, Range.combine(null, exampleRange));
	}
	
	@Test
	public void testCombineNullRange2() {
		assertEquals("Combining a null range with example range should return example range", exampleRange, Range.combine(exampleRange, null));
	}
	
	@Test
	public void testCombine() {
		Range r1 = new Range(-100,0);
		Range r2 = new Range(0,100);
		assertEquals("Combining two ranges should return example range", exampleRange, Range.combine(r1, r2));
	}
	
	@Test
	public void testCombineIgnoringNaN_NullRange1() {
		assertEquals("Combining a null range with example range should return example range", exampleRange, Range.combineIgnoringNaN(null, exampleRange));
	}
	
	@Test
	public void testCombineIgnoringNaN_NullRange1_NaNRange2() {
		Range NaNRange = new Range(Double.NaN, Double.NaN);
		assertEquals("Combining a null range with a NaN range should return null", null, Range.combineIgnoringNaN(null, NaNRange));
	}
	
	@Test
	public void testCombineIgnoringNaN_NullRange2() {
		assertEquals("Combining example range with a null range should reuturn example range", exampleRange, Range.combineIgnoringNaN(exampleRange, null));
	}
	
	@Test
	public void testCombineIgnoringNaN_NullRange2_NaNRange1() {
		Range NaNRange = new Range(Double.NaN, Double.NaN);
		assertEquals("Combining NaN range with a null range should return null", null, Range.combineIgnoringNaN(NaNRange, null));
	}
	
	@Test
	public void testCombineIgnoringNaN_NaNRanges() {
		Range NaNRange = new Range(Double.NaN, Double.NaN);
		assertEquals("Combining NaN ranges should return null", null, Range.combineIgnoringNaN(NaNRange, NaNRange));
	}
	...
	public void testCombineIgnoringNaN() {
		Range r1 = new Range(-100,0);
		Range r2 = new Range(0,100);
		assertEquals("Combining two ranges should return example range", exampleRange, Range.combineIgnoringNaN(r1, r2));
	}
	
	@Test
	public void testExpandNegativeScale() {
		Range r = new Range(100,100);
		assertEquals("Expanding example range by (-2,-1) should return (100,100)", r, Range.expand(exampleRange, -2, -1));
	}
	
	@Test
	public void testExpand() {
		Range r = new Range(300,500);
		assertEquals("Expanding example range by (-2,2) should return (300,500)", r, Range.expand(exampleRange, -2, 2));
	}
	
	@Test
	public void testShiftRange() {
		Range r = new Range(-95,105);
		assertEquals("Shifting example range by 5 should return (-95,105)", r, Range.shift(exampleRange, 5));
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testScaleNullRange() {
		Range r = Range.scale(null, 2);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testScaleNegativeFactor() {
		Range r = Range.scale(exampleRange, -2);
	}
	
	@Test
	public void testScale() {
		Range r = new Range (-200,200);
		assertEquals("Scaling example range by 2 should return (-200,200)", r, Range.scale(exampleRange, 2));
	}
	
	@Test
	public void testIsNaNRange_NaN_Range() {
		Range r = new Range (Double.NaN, Double.NaN);
		assertTrue("NaN range should return true", r.isNaNRange());
	}
	
	@Test
	public void testIsNaNRange_Example_Range() {
		assertFalse("Example range should return false", exampleRange.isNaNRange());
	}
